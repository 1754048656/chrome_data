...
class DumpAllTitle:
    def __init__(self):
        ...
        with open("home_msd_title.txt", 'r', encoding='utf-8') as file:
            for item in file:
                ...
                if sub_label == 'yes':
                    self.write2File('home_a_msd_detail.txt', json.dumps(json_line, ensure_ascii=False) + '\n')
                else:
                    self.write2File('home_b_msd_detail_error.txt', text_line)
